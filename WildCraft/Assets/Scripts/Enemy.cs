...
public class Enemy : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isAgressive)
        {
            ...
            if (Physics.Raycast(new Vector3(transform.position.x, transform.position.y + 0.5f, transform.position.z), transform.TransformDirection(Vector3.forward), out RaycastHit hit, 3, layerMask))
            {
                //Debug.DrawRay(new Vector3(transform.position.x, transform.position.y + 0.6f, transform.position.z), transform.TransformDirection(Vector3.forward) * hit.distance, Color.red);
            ...
            {
                //Debug.DrawRay(new Vector3(transform.position.x, transform.position.y + 0.6f, transform.position.z), transform.TransformDirection(Vector3.forward) * 3, Color.black);
